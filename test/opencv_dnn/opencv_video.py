...
def parse_args():
    ...
    parser.add_argument("--weights", type=str, default="E:\\MAGANG\\Project_iSense\\weights\\yolov4-tiny-416x416_best.weights", help="Path to YOLO weights file")
    parser.add_argument("--cfg", type=str, default="E:\\MAGANG\\Project_iSense\\cfg\\yolov4-tiny-416x416.cfg", help="Path to YOLO configuration file")
    parser.add_argument("--classes", type=str, default="E:\\MAGANG\\Project_iSense\\data\\obj.names", help="Path to YOLO classes file")
    parser.add_argument("--video", type=str, default="E:\\MAGANG\\Project_iSense\\Test\\video\\people_RT.mp4", help="Path to video file")
...
def main():
    ...
    output_video_path = "E:\\MAGANG\\Project_iSense\\Test\\video_output\\output_video_RT_1.mp4"  # Set your desired output video file path
